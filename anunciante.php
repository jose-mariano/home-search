...
<head>
    ...
    <link rel="icon" href="img/gerenciar.png" type="image/x-icon">
...
<body class="bg-gray-300">
    ...
    <div class="flex flex-1 w-full self-center">
        ...
        <div class="flex flex-1 w-full absolute justify-center self-center">
            <button class="inline-block w-72 h-20 text-2xl text-white bg-gray-700 mr-10 rounded-full hover:bg-blue-500">Anúncios Ativos</button>
            <button class="inline-block w-72 h-20 text-2xl text-white bg-gray-700 ml-10 rounded-full hover:bg-blue-500">Anúncios Inativos</button>
        </div>        
    </div>
    <!-- GRID ANUNCIOS -->
    <div class="flex flex-wrap justify-center">
        <div class="w-96 bg-white rounded-3xl flex-col p-5 m-1.5 my-5">
            ...
            <a href="" class="w-40 p-1.5 m-8 text-white bg-gray-700 hover:bg-blue-500 rounded-2xl">
                <img src="img/gerenciar.png" class="w-7 pb-1 inline-block" alt="Mais Detalhes"> Gerenciar</a>
        </div>
        <div class="w-96 bg-white rounded-3xl flex-col p-5 m-1.5 my-5">
